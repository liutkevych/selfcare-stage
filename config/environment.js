...
module.exports = function(environment) {
  ...
  if (environment === 'development') {
    ...
    ENV.SERVER_URL = 'https://selfcare-stage.herokuapp.com/' //'http://localhost:3000'
    ENV.contentSecurityPolicy['connect-src'][0] += "https://selfcare-stage.herokuapp.com/"; //"http://localhost:3000";
  }
